              ...
              do
                case $REPLY in
                  ...
                  4) # Install Required Files
                    ...
                    # General overlays
                    sudo mkdir -p "$raconfigdir/overlay/1080p_4-3"
                    sudo cp -r "$scriptdir/1080p_4-3/"* "$raconfigdir/overlay/1080p_4-3/"
                    # Thorig overlays
                    sudo cp -r "$scriptdir/users/thorig/overlays/"* "$raconfigdir/overlay/1080p_4-3/"
                    # davej Shaders
                    sudo cp -r "$scriptdir/users/davej/shaders/crt-pi/"* "$raconfigdir/shaders/"
                    # Chito Overlays
                    sudo mkdir -p "$raconfigdir/overlay/chito"
                    sudo cp -r "$scriptdir/users/chito/overlays/"* "$raconfigdir/overlay/chito/"
                    # Arcade Bezels
                    ...
                    sudo mkdir -p "$raconfigdir/overlay/arcade-bezel-overlays"
                    sudo cp -r "$scriptdir/users/arcade-bezels/arcade-bezel-overlays/"* "$raconfigdir/overlay/arcade-bezel-overlays/"
                    # Gameboy Palette
                    ...
                    sudo mkdir -p "$raconfigdir/overlay/effects/scanlines"
                    sudo cp "$scriptdir/shaders/patrickm-scanlines1920x1080-5x.cfg" "$raconfigdir/overlay/effects/scanlines/patrickm-scanlines1920x1080-5x.cfg"
                    sudo cp "$scriptdir/shaders/patrickm-scanlines1920x1080-5x.png" "$raconfigdir/overlay/effects/scanlines/patrickm-scanlines1920x1080-5x.png"
                    sudo cp "$scriptdir/shaders/patrickm-scanlines1920x1080.cfg" "$raconfigdir/overlay/effects/scanlines/patrickm-scanlines1920x1080.cfg"
